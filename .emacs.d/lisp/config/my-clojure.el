...
(defun evil-cider-keymaps ()
  ...
  (define-key evil-normal-state-map ",cmc" 'cider-macroexpand-1-inplace)
  (define-key evil-normal-state-map ",cmv" 'cider-macroexpand-all-inplace)
...
(add-hook 'clojurescript-mode-hook 'cljs-cider-autocomplete)

(add-hook 'clojure-mode-hook 'hideshowvis-enable)
(add-hook 'clojurescript-mode-hook 'hideshowvis-enable)

(add-hook 'clojure-mode-hook (lambda () (require 'cider-macroexpansion)))
