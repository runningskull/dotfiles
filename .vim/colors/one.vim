...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:syntax_cursor = ['#f8f8f8', '254']
  ...
  call <sid>X('Folded',       s:mono_3,        s:syntax_fold_bg, 'bold')
  call <sid>X('FoldColumn',   s:mono_3,        s:syntax_cursor,  '')
  call <sid>X('IncSearch',    s:hue_6,         '',               '')
  call <sid>X('LineNr',       s:special_grey,  '',               '')
  call <sid>X('CursorLineNr', s:special_grey,  '',               'none')
  ...
  call <sid>X('StatusLine',   s:mono_3,        s:syntax_cursor,  'reverse,bold')
  call <sid>X('StatusLineNC', s:mono_3,        s:vertsplit,      'none')
  ...
  call <sid>X('cTODO',              s:mono_3, '', 'bold')
  ...
  " my additions:
  call <sid>X('cType',              s:hue_1,  '', '')
  call <sid>X('cppType',            s:hue_1,  '', '')
  call <sid>X('cInclude',           s:hue_6_2,'', '')
  call <sid>X('cppSTLtype',         s:syntax_fg, '', '')
  call <sid>X('cppSTLnamespace',    s:syntax_fg, '', '')
  call <sid>X('cppSTLiterator',     s:syntax_fg, '', '')
  call <sid>X('cppBoolean',         s:hue_5, '', '')
  call <sid>X('cppSTLconstant',     s:hue_5, '', '')
  call <sid>X('cppConstant',        s:hue_5,  '', '')
  call <sid>X('cNumber',            s:hue_5, '', '')
  call <sid>X('cppFunctionDecl',    s:hue_2, '', 'bold')
  " }}}
