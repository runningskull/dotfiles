...
hi VertSplit            cterm=none ctermbg=0        ctermfg=1       gui=none        guibg=#5D5D5D   guifg=#FBFBFB
...
hi Folded               cterm=none ctermbg=235      ctermfg=243     gui=none        guibg=#3B3B3B   guifg=#90AB41
